...
export function OrderContent({ orderIngredientsIds, date }) {
  ...
  let orderIngredients = []; //так как через пропсы приходят только id ингредиентов, нам для построения компонентов нужно получить данные ингредиента целиком
